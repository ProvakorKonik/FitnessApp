...
public class PerformAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perform_add);
        mContestImage = (ImageView) findViewById(R.id.perform_add_imageview);
        mContestName = (EditText) findViewById(R.id.perform_add_name_edit);
        mContestSyllabus = (EditText) findViewById(R.id.perform_add_syllabus_edit);
        mContestPriorityNo = (EditText) findViewById(R.id.perform_add_priority_edit);
        mContestViewCount = (EditText) findViewById(R.id.perform_add_view_count_edit);
        mContestTotalQuestion = (EditText) findViewById(R.id.perform_add_total_question_edit);

        mContestDuration = (EditText) findViewById(R.id.perform_add_duration_edit);


        mContestUpdateBtn = (Button)findViewById(R.id.perform_add_update_btn);
        //Login Check
    ...
    private String dsContestViewCount = "NO", dsContestTotalQuestion = "NO";
    private String dsContestDuration = "NO";
    private int diPriority = 0, diContestDuration = 0;
    ...
    private void UploadCropedImageFunction(Uri filePath) {
        if(filePath != null)
        {
            ...
            ref = storageReference.child("StayFit/Beginner/"+ "AllPerformance"+"/"+ dsContestName+" "+dsTimeMiliSeconds +"."+getFileExtention(filePath));
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    note.put("ExerciseName", dsContestName);
                                    note.put("ExercisePhotoUrl", dPhotoURL);
                                    note.put("ExerciseVideoUrl", "NO");
                                    note.put("ExerciseVoiceUrl", "NO");
                                    note.put("ExerciseDetails", dsContestSyllabus);
                                    note.put("ExerciseExtra", "0");
                                    note.put("ExerciseiPriority", diPriority);
                                    note.put("ExerciseiRestSec", diContestViews);
                                    note.put("ExerciseiDuration", diContestDuration);
                                    note.put("ExerciseiSteps", diContestTotalQuestion);
                                    ...
                                    db.collection("StayFit").document("Info")
                                            ...
                                            .collection("AllExercise").add(note)
                                            .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                ...
                                                public void onSuccess(DocumentReference documentReference) {
                                                    ...
                                                    finish();
                                                    Intent intent = new Intent(PerformAdd.this, DayMain.class);    //Error Intent not sent
                                                    intent.setFlags(intent.getFlags() | Intent.FLAG_ACTIVITY_NO_HISTORY);
    ...
    private void getIntentMethod() {
        ...
        {
            dsDayUID = intentx.getExtras().getString("dsDayUID");    //Sylhet
